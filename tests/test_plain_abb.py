...
class PlainABBTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # FIXME use trustees and not the abbs, make it possible for the trustees to communticate locally again
        bulletin_board = BulletinBoard()
        
        abbs = PlainABB.gen_trustee_abbs(self.bits_key, self.n_shares, self.threshold, EmptyProtocolSuite)
        self.trustees = init_trustees(bulletin_board, abbs, [i for i, _ in enumerate(abbs)])
